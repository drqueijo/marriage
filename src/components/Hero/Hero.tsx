export const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="relative h-12 w-11 bg-separator bg-center bg-no-repeat">
        <div
      ...
      <div className="flex flex-col items-center justify-center gap-4  tracking-full">
        <p className="font-libre text-xl font-light text-gray-600">JULIANA</p>
        <img className="my-1" src="/img/svg/and.svg" />
        <p className="font-libre text-xl font-light tracking-full text-gray-600">
          GABRIEL
        </p>
      </div>
